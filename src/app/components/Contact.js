                ...
                <div className="space-y-4 mb-8">
                  {contactInfo.map((info, index) => (
                    <a
                      key={index}
                      href={info.href}
                      className="flex items-center gap-4 p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 group"
                      target={info.href.startsWith('http') ? '_blank' : undefined}
                      rel={info.href.startsWith('http') ? 'noopener noreferrer' : undefined}
                    >
                      <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-lg flex items-center justify-center text-white group-hover:scale-110 transition-transform">
                        {info.icon}
                      </div>
                      <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {socialLinks.map((social, index) => (
                      <a
                        ...
                        className={`flex items-center gap-2 px-4 py-3 bg-white dark:bg-gray-800 rounded-lg shadow-sm transition-all duration-300 ${social.bg} ${social.color} group`}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
              ...
              <div onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className={`w-full px-8 py-4 bg-emerald-600 text-white font-semibold rounded-lg shadow-md hover:bg-emerald-700 hover:shadow-lg transform hover:scale-105 transition-all duration-300 ease-in-out flex items-center justify-center gap-2 ${
                    isSubmitting 
                      ? 'opacity-75 cursor-not-allowed' 
                      : 'hover:shadow-2xl hover:shadow-purple-500/25 transform hover:scale-105'
                  }`}
                >
                  {isSubmitting ? (
                    <>
